              ...
              .map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{item.simtlixCode}</TableCell>
                    <TableCell align="right">{item.state}</TableCell>
                    <TableCell align="right">
                      {item.assignedCollaborator}
                    </TableCell>
                    <TableCell align="right">{item.requestedDate}</TableCell>
                    <TableCell align="right">{item.serialNumber}</TableCell>
                    <TableCell align="right">{}</TableCell>
                    <TableCell align="right">{item.warranty}</TableCell>
